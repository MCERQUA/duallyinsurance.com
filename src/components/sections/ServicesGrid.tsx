...
import { Truck, ShieldCheck, FileSignature, Car, Package, Umbrella, Wrench, DollarSign, ArrowRight } from "lucide-react";
      ...
      <div className="container-wide">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {SERVICES.map((service, i) => {
            ...
            const isFeatured = service.slug === "commercial-auto";
            return (
