                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="mt-2 text-mocha text-sm leading-relaxed">
                            ...
                            or call{" "}
                            <a href={SITE.phoneHref} className="font-heading font-bold text-clay underline decoration-clay/40 underline-offset-2 hover:decoration-clay whitespace-nowrap">{SITE.phone}</a>.
                          </p>
